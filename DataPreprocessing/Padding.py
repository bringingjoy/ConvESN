...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 2:
        raise Exception("Please specify a dataset and run again")
    dataset = sys.argv[1]
    ...
    P4_AS1_train = pickle.load(
        open("../data/" + dataset + "_" + protocol + "_Split_AS1_train.p", "rb"))
    print("Loading AS1_test  data ....")
    P4_AS1_test = pickle.load(
        open("../data/" + dataset + "_" + protocol + "_Split_AS1_test.p", "rb"))
    print("Loading AS2_train  data ....")
    P4_AS2_train = pickle.load(
        open("../data/" + dataset + "_" + protocol + "_Split_AS2_train.p", "rb"))
    print("Loading AS2_test  data ....")
    P4_AS2_test = pickle.load(
        open("../data/" + dataset + "_" + protocol + "_Split_AS2_test.p", "rb"))
    print("Loading AS3_train  data ....")
    P4_AS3_train = pickle.load(
        open("../data/" + dataset + "_" + protocol + "_Split_AS3_train.p", "rb"))
    print("Loading AS3_test  data ....")
    P4_AS3_test = pickle.load(
        open("../data/" + dataset + "_" + protocol + "_Split_AS3_test.p", "rb"))
