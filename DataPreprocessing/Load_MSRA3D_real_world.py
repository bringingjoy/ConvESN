        ...
        for s in subjects:
            for t in times:
                ...
                if flag == False:
                    ...
                    nums_frame = int(np.shape(jointMat)[0] / nums_skeleton)
                    ...
                    print("Line 53: Num frames:", n_frames, "num features:", n_features)
                    temp = frameMat
                    ...
                    n_frames, n_features = frameMat.shape
                    print("Line 62: Num frames:", n_frames, "num features:", n_features)
...
if __name__ == '__main__':
    filepath = "../data/MSRAction3D_Skeleton"
    """
    ...
    AS1_train_params = [AS1_a, subject_train, [1, 2, 3]]
    AS2_train_params = [AS2_a, subject_train, [1, 2, 3]]
    AS3_train_params = [AS3_a, subject_train, [1, 2, 3]]
    AS1_test_params = [AS1_a, subject_test, [1, 2, 3]]
    AS2_test_params = [AS2_a, subject_test, [1, 2, 3]]
    AS3_test_params = [AS3_a, subject_test, [1, 2, 3]]
    ...
    flag_created = True
    if flag_created:
        pickle.dump([AS1_train_left_hand, AS1_train_right_hand, AS1_train_left_leg, AS1_train_right_leg, AS1_train_central_trunk, AS1_train_Labels, max_frames[0]], open("../data/MSRAction3D_real_world_P4_Split_AS1_train.p", "wb"))
        pickle.dump([AS2_train_left_hand, AS2_train_right_hand, AS2_train_left_leg, AS2_train_right_leg, AS2_train_central_trunk, AS2_train_Labels, max_frames[1]], open("../data/MSRAction3D_real_world_P4_Split_AS2_train.p", "wb"))
        pickle.dump([AS3_train_left_hand, AS3_train_right_hand, AS3_train_left_leg, AS3_train_right_leg, AS3_train_central_trunk, AS3_train_Labels, max_frames[2]], open("../data/MSRAction3D_real_world_P4_Split_AS3_train.p", "wb"))
        pickle.dump([AS1_test_left_hand, AS1_test_right_hand, AS1_test_left_leg, AS1_test_right_leg, AS1_test_central_trunk,AS1_test_Labels, max_frames[3]], open("../data/MSRAction3D_real_world_P4_Split_AS1_test.p", "wb"))
        pickle.dump([AS2_test_left_hand, AS2_test_right_hand, AS2_test_left_leg, AS2_test_right_leg, AS2_test_central_trunk,AS2_test_Labels, max_frames[4]], open("../data/MSRAction3D_real_world_P4_Split_AS2_test.p", "wb"))
        pickle.dump([AS3_test_left_hand, AS3_test_right_hand, AS3_test_left_leg, AS3_test_right_leg, AS3_test_central_trunk,AS3_test_Labels, max_frames[5]], open("../data/MSRAction3D_real_world_P4_Split_AS3_test.p", "wb"))
